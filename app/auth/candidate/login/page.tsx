      ...
      <div className="w-full max-w-md bg-white border border-[#E2E8F0] rounded-xl p-6 sm:p-8 shadow-[0_1px_3px_rgba(15,23,42,0.04)] mx-auto my-auto space-y-6">
        <div className="text-center space-y-1">
          ...
          <p className="text-xs text-[#64748B]">
            Welcome back! Log in to manage your applications & job search.
          </p>
        </div>
        ...
        {submitSuccess ? (
          <div className="text-center py-6 space-y-4">
            ...
            <h2 className="text-lg font-semibold text-[#0F172A]">Logged In Successfully!</h2>
            <p className="text-xs text-[#64748B]">
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              >
                {isSubmitting ? "Logging in..." : "Log In as Candidate"}
              </Button>
            </form>
          </>
        )}
        ...
        <div className="text-center text-xs text-[#64748B]">
          ...
          <Link href="/auth/candidate/signup" className="text-[#6366F1] font-semibold hover:underline">
            Sign Up
          </Link>
        </div>
      </div>
