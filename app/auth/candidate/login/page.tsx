...
import { Briefcase, ArrowLeft, CheckCircle2, Lock, Mail, Eye, EyeOff } from "lucide-react";
      ...
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-xl p-8 shadow-xs mx-auto my-auto">
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-[#313638]/70 mt-1">
            Log in to manage your applications & job search
          </p>
        </div>
        ...
        {submitSuccess ? (
          <div className="text-center py-6 space-y-4">
            ...
            <h2 className="text-lg font-semibold text-[#0E103D]">Logged In Successfully!</h2>
            <p className="text-xs text-[#313638]/70">
              Redirecting to your candidate dashboard...
            </p>
            <Button onClick={() => router.push("/candidate")} variant="primary" size="md" className="w-full">
              Go to Dashboard
            </Button>
          </div>
        ) : (
        ...
        <div className="mt-6 text-center text-xs text-[#313638]/70">
          ...
          <Link href="/auth/candidate/signup" className="text-[#008DD5] font-semibold hover:underline">
            Sign up
          </Link>
        </div>
      </div>
