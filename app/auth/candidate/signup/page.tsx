      ...
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-xl p-8 shadow-xs mx-auto my-auto">
        ...
        {submitSuccess ? (
          <div className="text-center py-6 space-y-4">
            ...
            <h2 className="text-lg font-semibold text-[#0E103D]">Account Created!</h2>
            <p className="text-xs text-[#313638]/70">
              Welcome aboard, <span className="font-semibold text-[#0E103D]">{formData.name}</span>. Redirecting to your dashboard...
            </p>
        ...
        <div className="mt-6 text-center text-xs text-[#313638]/70">
          ...
          <Link href="/auth/candidate/login" className="text-[#008DD5] font-semibold hover:underline">
            Log in
          </Link>
        </div>
      </div>
