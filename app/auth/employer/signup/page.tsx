...
export default function EmployerSignupPage() {
  ...
  const validateForm = () => {
    ...
    return !compErr && !nameErr && !emailErr && !passwordErr;
  };
      ...
      <div className="w-full max-w-md bg-zinc-900/90 border border-zinc-800 backdrop-blur-xl rounded-md p-8 shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-400 mt-1">
            Register your company to hire top talent
          </p>
        </div>
        ...
        {submitSuccess ? (
          <div className="text-center py-6 space-y-4">
            ...
            <h2 className="text-xl font-semibold">Company Registered!</h2>
            <p className="text-sm text-zinc-400">
              Welcome, <span className="text-white font-medium">{formData.fullName}</span> from{" "}
              <span className="text-white font-medium">{formData.companyName}</span>. Your employer profile is ready.
            </p>
            <button
              onClick={() => {
