...
export default function EditJobForm({ job }: { job: any }) {
    return (
        <form action={updateJob} className="w-full flex justify-center items-center py-10 px-4">
            ...
            <div className="w-full max-w-3xl bg-white border border-slate-200 rounded-md shadow-sm p-6 sm:p-8 text-slate-900 flex flex-col">
                <h1 className="text-2xl font-bold text-slate-900 border-b border-slate-200 pb-4 mb-6">Edit Job Posting</h1>
                ...
                <div className="mt-8 flex justify-end gap-3">
                    <a
                        href="/employer/jobs"
                        className="px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-medium rounded-md transition-colors"
                    >
                        Cancel
                    </a>
                    <button
